...
use Buseta\BusesBundle\Form\Filter\ListaNegraCombustibleFilter;
use Buseta\BusesBundle\Form\Model\ListaNegraCombustibleFilterModel;
use Buseta\BusesBundle\Form\Type\ListaNegraCombustibleType;
...
class ListaNegraCombustibleController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        if($form->isSubmitted() && $form->isValid()) {
            $entities = $this->get('doctrine.orm.entity_manager')
                ->getRepository('BusetaBusesBundle:ListaNegraCombustible')->filter($filter);
        } else {
            $entities = $this->get('doctrine.orm.entity_manager')
                ->getRepository('BusetaBusesBundle:ListaNegraCombustible')->filter();
        }
        ...
        return $this->render('BusetaBusesBundle:ListaNegraCombustible:index.html.twig', array(
            'entities'      => $entities,
    ...
    public function newAction()
    {
        ...
        return $this->render('BusetaBusesBundle:ListaNegraCombustible:new.html.twig', array(
            'entity' => $entity,
    ...
    {
        $form = $this->createForm('buses_lista_negra_combustible', $entity, array(
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BusetaBusesBundle:ListaNegraCombustible')->find($id);
        ...
        return $this->render('BusetaBusesBundle:ListaNegraCombustible:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function deleteAction(ListaNegraCombustible $listaNegraCombustible, Request $request)
    {
        ...
        $renderView =  $this->renderView('@BusetaBuses/ListaNegraCombustible/delete_modal.html.twig', array(
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BusetaBusesBundle:ListaNegraCombustible:edit.html.twig', array(
            'entity'      => $entity,
