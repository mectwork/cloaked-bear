...
class LineaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BusetaTallerBundle:Linea')->findAll();

        return $this->render('BusetaTallerBundle:Linea:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('BusetaTallerBundle:Linea:new.html.twig', array(
            'entity' => $entity,
     ...
     * @return \Symfony\Component\Form\Form The form
     */
    private function createCreateCompraForm(Linea $entity)
    {
        $form = $this->createForm(new LineaType(), $entity, array(
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BusetaTallerBundle:Linea')->find($id);
        ...
        return $this->render('BusetaTallerBundle:Linea:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('BusetaTallerBundle:Linea:edit.html.twig', array(
            'entity'      => $entity,
