...
use Buseta\EmpleadosBundle\Entity\Empleado;
use Buseta\EmpleadosBundle\Form\EmpleadoType;
...
class EmpleadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BusetaEmpleadosBundle:Empleado')->findAll();
     ...
     * @Method("POST")
     * @Template("BusetaEmpleadosBundle:Empleado:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BusetaEmpleadosBundle:Empleado')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BusetaEmpleadosBundle:Empleado:edit.html.twig")
     */
